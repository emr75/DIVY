              ...
              <div className="investments-list">
                {investments.map((investment) => (
                  <div key={investment.id} className="investment-row">
                    <div className="investment-icon-box">{investment.icon}</div>
                ...
                <div className="settings-card">
                  ...
                  <div className="form-fields">
                    ...
                    <div className="form-field">
                      ...
                      <input type="text" value={userData.name} readOnly className="field-input" />
                    </div>
                    <div className="form-field">
                      <label className="field-label">Email Address</label>
                      <input type="email" value={userData.email} readOnly className="field-input" />
                    </div>

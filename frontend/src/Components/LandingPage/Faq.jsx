            ...
            <div className="faq-container">
                ...
                <div className={`faq-item ${openIndex === 0 ? 'open' : ''}`}>
                    ...
                    <div className="faq-answer">
                        <p>
                            Fractional ownership allows you to own a percentage of high-value assets by purchasing shares.
                            Instead of buying an entire luxury condo or high-value stocks, you can invest in a portion and
                            benefit from its appreciation and potential returns.
                        </p>
                    </div>
                </div>
                ...
                <div className={`faq-item ${openIndex === 1 ? 'open' : ''}`}>
                    ...
                    <div className="faq-answer">
                        <p>
                            ...
                            and purchase shares starting from as little as $50. Your ownership is immediately recorded.
                        </p>
                    </div>
                </div>
                ...
                <div className={`faq-item ${openIndex === 2 ? 'open' : ''}`}>
                    ...
                    <div className="faq-answer">
                        <p>
                            ...
                            at any time. Other investors can purchase your shares, giving you the flexibility
                            to exit investments when needed.
                        </p>
                    </div>
                </div>
                ...
                <div className={`faq-item ${openIndex === 3 ? 'open' : ''}`}>
                    ...
                    <div className="faq-answer">
                        <p>
                            All assets are thoroughly vetted by industry experts before listing.
                        </p>
                    </div>
                </div>
                ...
                <div className={`faq-item ${openIndex === 4 ? 'open' : ''}`}>
                    ...
                    <div className="faq-answer">
                        <p>
                            DIVY charges a 2% transaction fee when buying or selling shares.
                        </p>
                    </div>
                </div>
                ...
                <div className={`faq-item ${openIndex === 5 ? 'open' : ''}`}>
                    ...
                    <div className="faq-answer">
                        <p>
                            ...
                            with regulatory requirements. However, like all investments, asset values can fluctuate
